...
export const DEFAULT_TASK_TEMPLATES: readonly TemplateSeed[] = [
  ...
  { phase: 0, name: "Volume & value targets by chain", spec: "AOP targets, 9L cases and net revenue" },
  ...
  { phase: 1, name: "Internal JBP brief", spec: "Reason to exist, right to win, negotiation range" },
  { phase: 1, name: "Spend envelope & pricing guardrails" },
  { phase: 1, name: "Shopper program menu for the chain profile", spec: "Which mechanics fit the banner" },
  { phase: 2, name: "Joint distributor plan", spec: "Goals, incentives, who leads the buyer meeting" },
  { phase: 2, name: "Distributor capability check", spec: "Delivery windows, MOQs, warehouse allocation" },
  ...
  { phase: 4, name: "Document & book agreed terms", spec: "Scan-back schedule, off-invoice, program calendar" },
  { phase: 4, name: "Confirm distributor readiness", spec: "Inventory build, allocation, delivery windows" },
  { phase: 4, name: "State ABC compliance review", spec: "Pricing and POS rules for the agreed programs" },
  ...
  { phase: 6, category: "Retail Mktg Mechanics", name: "Store photo audit", spec: "GPS-tagged photo per store" },
  { phase: 6, category: "Retail Mktg Mechanics", name: "Price compliance check" },
  { phase: 7, name: "Post-promo depletion pull", spec: "Baseline vs. promotional period vs. uplift" },
