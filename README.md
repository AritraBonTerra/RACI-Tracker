...
chain plans and promotions wherever their grant reaches in full
(`docs/adr/0004-…`), while plan years, deleting a plan or promotion, the
reference data and the People directory are Administrator-only.
