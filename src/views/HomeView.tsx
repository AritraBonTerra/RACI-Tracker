...
import { PHASES, responsiblesOf, STATUSES } from "../lib/domain";
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
        ...
        <RollupChips verbose rollup={data.seasonRollup} />
      </div>
        ...
        <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
          <h2 className="flex flex-wrap items-baseline gap-x-2">
            ...
            <span className="text-2xs text-ink-500">
              ...
              {group.plan.jbpDate !== undefined && ` · JBP ${formatDay(group.plan.jbpDate, today)}`}
            </span>
          </h2>
